  ...
  return (
    <div className="relative" ref={dropdownRef}>
      <button
        ...
        className="flex items-center gap-2 px-3 py-1.5 rounded-full nice-shadow bg-[#059669] text-white hover:bg-white hover:text-black transition-colors text-sm font-medium"
      >
        <Share2 size={14} />
